                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs btn-group">
                                                            <a href="${pageContext.request.contextPath}/showSubjectById.action?subjectId=${subject.subjectId}">
                                                                <button style="width: 66px;height: 32px; border-radius: 6px; background-color: #438EB9; color: #FFFFFF;">
                                                                    修改
                                                                </button>
                                                            </a>
                                                            <a href="${pageContext.request.contextPath}/deleteSubjectById.action?subjectId=${subject.subjectId}">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xs-12 col-sm-2">
                                                                    <div class="text-center">
                                                                        <img height="150" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="${subject.picPath}"/>
                                                                        <br />
                ...
                <ul class="pagination">
                    <c:choose>
                        <c:when test="${page.number == 0}">
                            <li><a href="${pageContext.request.contextPath}/pageSubject.action?currentPage=1">首页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageSubject.action?currentPage=${page.number + 1 + 1}">下一页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageSubject.action?currentPage=${page.totalPages}">尾页</a></li>
                        </c:when>
                        <c:when test="${page.number == page.totalPages - 1}">
                            <li><a href="${pageContext.request.contextPath}/pageSubject.action?currentPage=1">首页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageSubject.action?currentPage=${page.number + 1 - 1}">上一页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageSubject.action?currentPage=${page.totalPages}">尾页</a></li>
                        </c:when>
                        <c:otherwise>
                            <li><a href="${pageContext.request.contextPath}/pageSubject.action?currentPage=1">首页</a></li>
