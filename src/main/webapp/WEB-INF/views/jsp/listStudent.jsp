                                            ...
                                            <c:forEach items="${page.content}" var="student">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <c:if test="${student.gender.value == 12}">
                                                            女
                                                        </c:if>
                                                    </td>
                ...
                <ul class="pagination">
                    <c:choose>
                        <c:when test="${page.number == 0}">
                            <li><a href="${pageContext.request.contextPath}/pageStudent.action?currentPage=1">首页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageStudent.action?currentPage=${page.number + 1 + 1}">下一页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageStudent.action?currentPage=${page.totalPages}">尾页</a></li>
                        </c:when>
                        <c:when test="${page.number == page.totalPages - 1}">
                            <li><a href="${pageContext.request.contextPath}/pageStudent.action?currentPage=1">首页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageStudent.action?currentPage=${page.number + 1 - 1}">上一页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageStudent.action?currentPage=${page.totalPages}">尾页</a></li>
                        </c:when>
                        <c:otherwise>
                            <li><a href="${pageContext.request.contextPath}/pageStudent.action?currentPage=1">首页</a></li>
