        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="${pageContext.request.contextPath}/saveStudent.action" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-xs-8" style="text-align: center;">
                                    ...
                                    <table class="table table-bordered" style="text-align: center;">
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="studentName" placeholder="请输入姓名"/></td>
                                        </tr>
                                        <tr>
                                            <td>性别:</td>
                                            <td>
