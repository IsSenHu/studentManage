        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="${pageContext.request.contextPath}/updateGrade.action" method="post">
                            <input type="hidden" name="studentNumber" value="${grade.studentNumber}"/>
                            <input type="hidden" name="gradeId" value="${grade.gradeId}"/>
                            <input type="hidden" name="avgScore" value="${grade.avgScore}"/>
                            <input type="hidden" name="studentIdOffset" value="${grade.studentIdOffset}"/>
                            <div class="row">
