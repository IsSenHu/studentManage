        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="${pageContext.request.contextPath}/addSubject.action" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-xs-8" style="text-align: center;">
                                    ...
                                    <table class="table table-bordered" style="text-align: center;">
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="subjectName" placeholder="请输入学科名"/></td>
                                        </tr>
                                        <tr>
                                            <td>照片:</td>
