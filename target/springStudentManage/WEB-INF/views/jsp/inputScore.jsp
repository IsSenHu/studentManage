        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="${pageContext.request.contextPath}/inputScore.action" method="post">
                            <input type="hidden" class="form-control" value="${student.studentId}" name="studentPO.studentId"/>
                            <input type="hidden" class="form-control" value="${student.id}" name="studentPO.id"/>
                            <div class="row">
                                ...
                                <div class="col-xs-8" style="text-align: center;">
                                    ...
                                    <table class="table table-bordered" style="text-align: center;">
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" value="${student.studentId}" disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td>姓名:</td>
                                            <td><input type="text" class="form-control" value="${student.studentName}" disabled="disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td>学科:</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>分数:</td>
                                            <td><input type="text" class="form-control" name="score" placeholder="请输入分数"/></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>
