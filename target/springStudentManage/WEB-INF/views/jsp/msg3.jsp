            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12" style="text-align: center;">
                        <h2 style="color: green;">${msg}</h2><br>
                        <a href="${pageContext.request.contextPath}/toAddSubject.action"><button style="width: 86px;height: 32px; border-radius: 6px; background-color: #438EB9; color: #FFFFFF;">添加学科</button></a>
                        <a href="${pageContext.request.contextPath}/pageSubject.action"><button style="width: 126px;height: 32px; border-radius: 6px; background-color: #438EB9; color: #FFFFFF;">返回学科列表</button></a>
                    </div>
                </div>
            </div><!-- /.page-content -->
        </div>
