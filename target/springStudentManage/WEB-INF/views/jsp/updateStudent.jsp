                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="${pageContext.request.contextPath}/updateStudent.action" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="picPath" value="${student.picPath}"/>
                            <input type="hidden" name="subjectNumber" value="${student.subjectNumber}"/>
                            <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="sex" class="form-control">
                                                    <option value="11" <c:if test="${student.gender.value == 11}">selected="selected"</c:if>>男</option>
                                                    <option value="12" <c:if test="${student.gender.value == 12}">selected="selected"</c:if>>女</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>出生日期:</td>
                                            <td><input title="datetimepicker" value="<fmt:formatDate value="${student.birthday}" pattern="yyyy-MM-dd"></fmt:formatDate>" class="form-control" name="birthday" type="text" id="demo" placeholder="请选择出生日期"/></td>
                                        </tr>
                                        <tr>
                                            <td>所在班级:</td>
                                            <td>
