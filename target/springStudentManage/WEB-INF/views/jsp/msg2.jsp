            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12" style="text-align: center;">
                        ...
                        <a href="${pageContext.request.contextPath}/pageGrade.action"><button style="width: 126px;height: 32px; border-radius: 6px; background-color: #438EB9; color: #FFFFFF;">返回班级列表</button></a>
                    </div>
                </div>
            </div><!-- /.page-content -->
        </div>
